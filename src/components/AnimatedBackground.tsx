// Most of this code was "borrowed" from cameronknight
...
const AnimatedBackground = () => {
  ...
  useEffect(() => {
    ...
    scene.background = new THREE.Color(0x0a3a2a)
    ...
    const uniforms = {
      ...
      uColor1: { value: new THREE.Vector3(0.55, 0.55, 0.55) },
      uColor2: { value: new THREE.Vector3(0.15, 0.15, 0.15) },
      uColor3: { value: new THREE.Vector3(0.75, 0.75, 0.75) },
      uColor4: { value: new THREE.Vector3(0.10, 0.10, 0.10) },
      uColor5: { value: new THREE.Vector3(0.65, 0.65, 0.65) },
      uColor6: { value: new THREE.Vector3(0.20, 0.20, 0.20) },
      ...
      uZoom: { value: 1.0 },
      uDarkNavy: { value: new THREE.Vector3(0.05, 0.2, 0.15) },
    ...
    const onResize = () => {
      ...
      if (mesh) {
        ...
        mesh.geometry = new THREE.PlaneGeometry(newViewSize.width, newViewSize.height, 1, 1)
      }
